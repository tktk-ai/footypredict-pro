...
subprocess.check_call([sys.executable, "-m", "pip", "install", "-q", "pennylane", "pennylane-lightning"])
...
class UltraAdvancedFootballPredictor:
    ...
    def preprocess_data(self, df: pd.DataFrame) -> Tuple[np.ndarray, np.ndarray]:
        ...
        # Clean data: replace inf and fill NaN
        X_raw = processed.values.astype(np.float64)
