...
class SureBetsGenerator:
    ...
    def generate_all_lists(self) -> Dict:
        ...
        # If no matches from DB, generate demo predictions
        if not matches:
    ...
    def _get_demo_matches(self) -> List[Dict]:
        """Get demo matches for testing."""
        return [
            {'home_team': 'Manchester City', 'away_team': 'Arsenal', 'league': 'Premier League', 'kickoff': '15:00'},
            {'home_team': 'Liverpool', 'away_team': 'Manchester United', 'league': 'Premier League', 'kickoff': '17:30'},
            {'home_team': 'Real Madrid', 'away_team': 'Barcelona', 'league': 'La Liga', 'kickoff': '21:00'},
            {'home_team': 'Bayern Munich', 'away_team': 'Borussia Dortmund', 'league': 'Bundesliga', 'kickoff': '18:30'},
            {'home_team': 'PSG', 'away_team': 'Marseille', 'league': 'Ligue 1', 'kickoff': '20:45'},
            {'home_team': 'Juventus', 'away_team': 'AC Milan', 'league': 'Serie A', 'kickoff': '20:45'},
            {'home_team': 'Ajax', 'away_team': 'PSV', 'league': 'Eredivisie', 'kickoff': '16:30'},
            {'home_team': 'Sporting CP', 'away_team': 'Benfica', 'league': 'Liga Portugal', 'kickoff': '21:30'},
            {'home_team': 'Celtic', 'away_team': 'Rangers', 'league': 'Scottish Premiership', 'kickoff': '12:30'},
            {'home_team': 'Fenerbahce', 'away_team': 'Galatasaray', 'league': 'Super Lig', 'kickoff': '19:00'},
            {'home_team': 'Inter Milan', 'away_team': 'Napoli', 'league': 'Serie A', 'kickoff': '18:00'},
            {'home_team': 'Atletico Madrid', 'away_team': 'Sevilla', 'league': 'La Liga', 'kickoff': '16:15'},
        ]
